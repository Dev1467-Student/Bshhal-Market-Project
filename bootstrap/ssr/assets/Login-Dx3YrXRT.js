...
function Checkbox({
  ...
  return /* @__PURE__ */ jsx(
    "input",
    {
      ...props,
      type: "checkbox",
      className: "checkbox checkbox-sm checked:bg-violet-900 checked:text-white border-gray-300 shadow-sm focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800 " + className
    }
  );
}
function Login({
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "p-8", children: /* @__PURE__ */ jsx("div", { className: "card bg-white shadow max-w-[420px] mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "card-body", children: [
